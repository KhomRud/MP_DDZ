...
${OBJECTDIR}/Cacher/Cacher.o: Cacher/Cacher.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cacher/Cacher.o Cacher/Cacher.cpp

${OBJECTDIR}/Sender/Sender.o: Sender/Sender.cpp
	${MKDIR} -p ${OBJECTDIR}/Sender
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sender/Sender.o Sender/Sender.cpp
...
${TESTDIR}/Tests/Sender/RunSenderTests.o: Tests/Sender/RunSenderTests.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/Tests/Sender/RunSenderTests.o Tests/Sender/RunSenderTests.cpp


${TESTDIR}/Tests/Sender/SenderTests.o: Tests/Sender/SenderTests.cpp 
	${MKDIR} -p ${TESTDIR}/Tests/Sender
	${RM} "$@.d"
	$(COMPILE.cc) -g `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/Tests/Sender/SenderTests.o Tests/Sender/SenderTests.cpp
...
${OBJECTDIR}/Cacher/Cacher_nomain.o: ${OBJECTDIR}/Cacher/Cacher.o Cacher/Cacher.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cacher/Cacher_nomain.o Cacher/Cacher.cpp;\
	else  \
...
${OBJECTDIR}/Sender/Sender_nomain.o: ${OBJECTDIR}/Sender/Sender.o Sender/Sender.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sender/Sender_nomain.o Sender/Sender.cpp;\
	else  \
