...
${OBJECTDIR}/Casher/Cacher.o: Casher/Cacher.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Casher/Cacher.o Casher/Cacher.cpp

${OBJECTDIR}/Sender/Sender.o: Sender/Sender.cpp
	${MKDIR} -p ${OBJECTDIR}/Sender
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sender/Sender.o Sender/Sender.cpp
